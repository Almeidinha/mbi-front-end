...
export enum Keys {
  ...
  FETCH_METRIC_RESTRICTIONS = 'FETCH_METRIC_RESTRICTIONS',
  DELETE_METRIC_RESTRICTIONS = 'DELETE_METRIC_RESTRICTIONS',
  DELETE_ALL_RESTRICTIONS = 'DELETE_ALL_RESTRICTIONS',
  SAVE_RESTRICTIONS = 'SAVE_RESTRICTIONS'
}
